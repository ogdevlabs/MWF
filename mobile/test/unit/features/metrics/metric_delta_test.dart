...
void main() {
  group('computeMetricDelta', () {
    LocalMetricLog _makeLog(double value, DateTime loggedAt) {
    ...
    test('returns null for single log', () {
      final logs = [_makeLog(72.0, DateTime(2026, 5, 1))];
      expect(computeMetricDelta(logs), isNull);
    });

    test('returns negative delta for weight decrease', () {
      final logs = [
        _makeLog(72.0, DateTime(2026, 5, 1)),
        _makeLog(69.7, DateTime(2026, 5, 28)),
      ];
    ...
    test('returns positive delta for flexibility increase', () {
      final logs = [
        _makeLog(15.0, DateTime(2026, 5, 1)),
        _makeLog(22.0, DateTime(2026, 5, 28)),
      ];
    ...
    test('returns 0.0 for no change', () {
      final logs = [
        _makeLog(70.0, DateTime(2026, 5, 1)),
        _makeLog(70.0, DateTime(2026, 5, 28)),
      ];
